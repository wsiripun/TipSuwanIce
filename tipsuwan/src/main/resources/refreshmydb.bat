...
insert into Employees (ACTIVE, PASSWORD, USER_ROLE, firstName, lastName) values (1, '123', 'FrontDesk', 'Beer', 'BeerLastName');
insert into Employees (ACTIVE, PASSWORD, USER_ROLE, firstName, lastName) values (1, '123', 'BackRoom', 'B', 'BLastName');
